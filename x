...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/MakaCheese/iy/main/x'))()")
	end
end)
...
addcmd("sp",{},function(args,speaker)
	...
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-194, 4, 312)
	wait(.1)
	egg()
	hive()
	egg2()
	Purchase()
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-129, 4, 258)
	wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-195, 6, 323)
	wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-129, 4, 258)
	wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-147, 4, 270)
	wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-67, 4, 288)
	wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-432, 117, 50)
end)

addcmd("selfban",{},function(args,speaker)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-11.272645, 64.8299866, 363.976318, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end)
...
-- loadstring(game:HttpGet("https://raw.githubusercontent.com/MakaCheese/iy/main/x"))()

-- game:GetService("Players").LocalPlayer.PlayerGui.HUD.Main.Currencies.Gems.Gems.Text = tonumber(game:GetService("Players").LocalPlayer.PlayerGui.HUD.Main.Currencies.Gems.Gems.Text) + 10000
